...
public class CalcPrecoPrazoWSLocator extends org.apache.axis.client.Service implements moda.praia.modulo.correios.webservices.CalcPrecoPrazoWS {
    ...
    public moda.praia.modulo.correios.webservices.CalcPrecoPrazoWSSoap getCalcPrecoPrazoWSSoap() throws javax.xml.rpc.ServiceException {
    ...
    public moda.praia.modulo.correios.webservices.CalcPrecoPrazoWSSoap getCalcPrecoPrazoWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            moda.praia.modulo.correios.webservices.CalcPrecoPrazoWSSoapStub _stub = new moda.praia.modulo.correios.webservices.CalcPrecoPrazoWSSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (moda.praia.modulo.correios.webservices.CalcPrecoPrazoWSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                moda.praia.modulo.correios.webservices.CalcPrecoPrazoWSSoapStub _stub = new moda.praia.modulo.correios.webservices.CalcPrecoPrazoWSSoapStub(new java.net.URL(CalcPrecoPrazoWSSoap_address), this);
                _stub.setPortName(getCalcPrecoPrazoWSSoapWSDDServiceName());
                return _stub;
            }
        }
