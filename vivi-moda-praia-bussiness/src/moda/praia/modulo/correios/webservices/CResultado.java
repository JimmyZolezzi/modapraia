...
public class CResultado  implements java.io.Serializable {
    private moda.praia.modulo.correios.webservices.CServico[] servicos;

    public CResultado() {
    }

    public CResultado(
           moda.praia.modulo.correios.webservices.CServico[] servicos) {
     ...
     * @return servicos
     */
    public moda.praia.modulo.correios.webservices.CServico[] getServicos() {
        return servicos;
    }
     ...
     * @param servicos
     */
    public void setServicos(moda.praia.modulo.correios.webservices.CServico[] servicos) {
        this.servicos = servicos;
    }
