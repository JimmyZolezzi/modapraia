...
<div id="wrapper">
	...
	<div class="container" >
		...
		<div class="collapse navbar-collapse fonteMenu"
			...
			<ul  class="nav navbar-nav menuCarrinho2">
				...
				<c:if test="${empty categoria }">
					...
					<a href="<c:url value="/produtos/{{categoria.id}}" />" ng-if="categoria.subcategorias.length!=0" data-toggle="dropdown"	aria-expanded="false">
						{{categoria.descricao}} 
